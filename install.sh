...
if [ "$cek" = "19" ]; then
wget --no-check-certificate "https://github.com/wegare123/shadowsocksr-tunnel-badvpn-tun2socks/blob/main/shadowsocksr-libev_1-0-0-wegare_aarch64_cortex-a53.ipk?raw=true" -O ~/ssr-libev.ipk
elif [ "$cek" = "18" ]; then
wget --no-check-certificate "https://github.com/wegare123/shadowsocksr-tunnel-badvpn-tun2socks/blob/main/shadowsocksr-libev_2.5.6-5_aarch64_cortex-a53.ipk?raw=true" -O ~/ssr-libev.ipk
else
